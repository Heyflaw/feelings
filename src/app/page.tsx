...
export default function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>Feelings – Generative Art</title>
        <meta
          name="description"
          content="Feelings is a generative art project coded in p5.js, transforming emotions into visible art."
        />
        <meta property="og:title" content="Feelings – Generative Art" />
        <meta
          property="og:description"
          content="Born from a tough year, Feelings is a generative art project coded in p5.js. Create and share unique artworks."
        />
        <meta
          property="og:image"
